...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", getenv("OWNER_ID", "")))
...
# Your User ID.
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [1668304150]
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL","https://t.me/SOURCE_TWINS1")
  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP","https://t.me/source_twins3)
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://t.me/QA_Z1O/6")
